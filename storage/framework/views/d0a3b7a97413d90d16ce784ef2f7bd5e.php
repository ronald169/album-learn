...
<?php $component = Mary\View\Components\Card::resolve(['title' => ''.e(__('Create a new category')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Name','wire:model' => 'name']); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => ''.e(__('Cancel')).'','link' => '/categories'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\album\resources\views\livewire/categories/create.blade.php ENDPATH**/ ?>