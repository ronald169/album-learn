    ...
    <div class="flex-1 relative">
        ...
        <input
            ...
            <?php if($money): ?>
                x-ref="myInput"
                :value="amount"
                @input="$nextTick(() => $wire.set('<?php echo e($modelName()); ?>', Currency.getUnmasked(), false))"
                inputmode="numeric"
            <?php endif; ?>
...
<?php endif; ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\laragon\www\album\storage\framework\views/9ecb275873f211385cda9714bfff4b49.blade.php ENDPATH**/ ?>