...
<?php $component = Mary\View\Components\Card::resolve(['title' => ''.e(__('Update profile')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($email).'','wire:model' => 'email']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal87f517fb1e90b7a7a96492b753df0c66 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal87f517fb1e90b7a7a96492b753df0c66 = $attributes; } ?>
<?php $component = Mary\View\Components\Range::resolve(['label' => 'Pagination ('.e($pagination).')','min' => '3','max' => '20','hint' => ''.e(__('Between 3 and 20')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('range'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Range::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce' => 'pagination','step' => '1','class' => 'range-accent']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal87f517fb1e90b7a7a96492b753df0c66)): ?>
<?php $attributes = $__attributesOriginal87f517fb1e90b7a7a96492b753df0c66; ?>
<?php unset($__attributesOriginal87f517fb1e90b7a7a96492b753df0c66); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal87f517fb1e90b7a7a96492b753df0c66)): ?>
<?php $component = $__componentOriginal87f517fb1e90b7a7a96492b753df0c66; ?>
<?php unset($__componentOriginal87f517fb1e90b7a7a96492b753df0c66); ?>
<?php endif; ?>
...
<?php $component = Mary\View\Components\Checkbox::resolve(['label' => ''.e(__('I am an adult')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => ''.e(__('Delete account')).'','icon' => 'c-hand-thumb-down'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:confirm' => ''.e(__('Are you sure to delete your account?')).'','wire:click' => 'deleteAccount','class' => 'btn-warning']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\album\resources\views\livewire/auth/profile.blade.php ENDPATH**/ ?>