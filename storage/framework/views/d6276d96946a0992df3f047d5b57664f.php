...
<?php $component = Mary\View\Components\Button::resolve(['icon' => 'o-power','tooltipLeft' => 'logoff','noWireNavigate' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\MenuItem::resolve(['title' => ''.e(__('Login')).'','icon' => 'o-user','link' => '/login'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
