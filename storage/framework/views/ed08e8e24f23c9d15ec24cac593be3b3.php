...
<?php $component = Mary\View\Components\Header::resolve(['title' => ''.e(__('Albums')).'','separator' => true,'progressIndicator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Table::resolve(['headers' => $headers,'rows' => $albums,'link' => 'albums/{id}/edit'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <?php $loop = null; $__env->slot('actions', function($album) use ($__env) { $loop = (object) $__env->getLoopStack()[0] ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'delete('.e($album->id).')','wire:confirm' => ''.e(__('Are you sure to delete this album?')).'','class' => 'btn-sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\album\resources\views\livewire/albums/index.blade.php ENDPATH**/ ?>