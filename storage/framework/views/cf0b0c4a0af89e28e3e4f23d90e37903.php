...
<?php $component = Mary\View\Components\Card::resolve(['title' => ''.e(__('Create a new album')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => ''.e(__('Cancel')).'','link' => '/'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\album\resources\views\livewire/albums/create.blade.php ENDPATH**/ ?>