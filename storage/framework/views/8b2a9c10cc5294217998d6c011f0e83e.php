...
<?php $component = Mary\View\Components\Header::resolve(['title' => ''.e(__('Categories')).'','separator' => true,'progressIndicator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Table::resolve(['headers' => $headers,'rows' => $categories,'link' => 'categories/{id}/edit'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php $loop = null; $__env->slot('actions', function($category) use ($__env) { $loop = (object) $__env->getLoopStack()[0] ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'delete('.e($category->id).')','wire:confirm' => ''.e(__('Are you sure to delete this category?')).'','class' => 'btn-sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\album\resources\views\livewire/categories/index.blade.php ENDPATH**/ ?>